...
int main()
{
    ...
    int x = ScreenW / 2 - 250, y = 600; // The Players postion in the screen
    int dir = 1;                        // Player Direction : 1-forward, 2-right, 3-backward, 4-left
    int step = 5;                       // How many steps for the player
    ...
    // for the screen and movements around
    ...
    while (1)
    {
        ...
        outtextxy(ScreenW + 20, 550, "A - Rotate Counter-Clockwise");
...
// Looks to see if another player was hit
